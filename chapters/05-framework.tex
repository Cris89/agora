...
Mandatory information AgoràLocalAppHandler modules have to send is:
...
\begin{enumerate}
    ...
    Agorà focuses on the prediction of continuous functions with normal distribution: corresponding family is the Gaussian one, indicated with word \textit{gaussian}. For Gaussian family, link function can be:
